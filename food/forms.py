# Ваш_проект/ваше_приложение/forms.py
...
class FoodFilterForm(forms.Form):
    ...
    min_price = forms.DecimalField(min_value=0, required=False, label='Максимальная цена')
    max_price = forms.DecimalField(min_value=0, required=False, label='Минимальная цена')
